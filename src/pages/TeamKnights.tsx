...
import { Shield, Activity, Hash, Users, Zap, Globe, Cpu } from "lucide-react";

export default function TeamKnights() {
    return (
        <div className="py-24 max-w-7xl mx-auto px-6">
            ...
            >
                <div className="lg:col-span-8">
                    ...
                    <p className="text-xl max-w-2xl border-l-4 border-blue-600 pl-6 py-2 text-slate-600 leading-relaxed">
                        Our defensive powerhouse, heavily focused on
                        structurally impenetrable robot designs and consistent
                        endgame execution.
                    </p>
                </div>
                ...
                <div className="lg:col-span-4 flex justify-center lg:justify-end items-start">
                    <div className="w-48 h-48 border-4 border-slate-900 bg-white flex items-center justify-center shadow-2xl relative overflow-hidden group">
                        ...
                        <Shield className="w-24 h-24 text-slate-900 group-hover:text-blue-600 transition-colors relative z-10" />
                    </div>
                </div>
            </motion.div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-16">
                {[
                    { label: "Matches", value: "48", icon: Activity },
                    { label: "Opr Avg", value: "20.33", icon: Hash },
                    { label: "Members", value: "16", icon: Users },
                    { label: "Outreach", value: "25+", icon: Globe },
                ].map((stat, i) => (
                    <motion.div
                        key={i}
                ...
                >
                    ...
                    <div className="space-y-6 relative z-10">
                        ...
                        <div className="flex justify-between items-center border-b border-lime-500 pb-4">
                            ...
                            <span className="text-xl font-bold">Tank</span>
                        </div>
                        <div className="flex justify-between items-center border-b border-lime-500 pb-4">
                            <span className="text-sm uppercase tracking-wider text-slate-400 font-bold font-oxanium">
                                Status
