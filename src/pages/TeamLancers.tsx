...
import { Swords, Activity, Hash, Users, Zap, Globe, Cpu } from "lucide-react";

export default function TeamLancers() {
    return (
        <div className="py-24 max-w-7xl mx-auto px-6">
            ...
            >
                <div className="lg:col-span-8">
                    ...
                    <p className="text-xl max-w-2xl border-l-4 border-blue-600 pl-6 py-2 text-slate-600 leading-relaxed">
                        The vanguard of our program, focusing on innovative
                        drive systems and rapid point scoring. They set the pace
                        for competition.
                    </p>
                </div>
                ...
                <div className="lg:col-span-4 flex justify-center lg:justify-end items-start">
                    <div className="w-48 h-48 border-4 border-slate-900 bg-white flex items-center justify-center shadow-2xl relative overflow-hidden group">
                        ...
                        <Swords className="w-24 h-24 text-slate-900 group-hover:text-blue-600 transition-colors relative z-10" />
                    </div>
                </div>
            </motion.div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-16">
                {[
                    { label: "Matches", value: "67", icon: Activity },
                    { label: "Opr Avg", value: "66.33", icon: Hash },
                    { label: "Members", value: "15", icon: Users },
                    { label: "Outreach", value: "40+", icon: Globe },
                ].map((stat, i) => (
                    <motion.div
                        key={i}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                ...
                >
                    ...
                    <div className="space-y-6 relative z-10">
                        <div className="flex justify-between items-center border-b border-lime-500 pb-4">
                            ...
                            <span className="text-xl font-bold">Excalibur</span>
                        </div>
                        <div className="flex justify-between items-center border-b border-lime-500 pb-4">
                            <span className="text-sm uppercase tracking-wider text-slate-400 font-bold font-oxanium">
                                Drivetrain
                            </span>
                            <span className="text-xl font-bold">Mecanum</span>
                        </div>
                        <div className="flex justify-between items-center border-b border-lime-500 pb-4">
                            <span className="text-sm uppercase tracking-wider text-slate-400 font-bold font-oxanium">
                                Status
                ...
                >
                    ...
                    <ul className="space-y-4">
                        {["Odometry", "Color Sensor", "Distance Sensor"].map(
                            (sensor, idx) => (
                                <li
                                    key={idx}
